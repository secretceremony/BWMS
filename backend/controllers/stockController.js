...
const updateStockQuantity = async (itemId, quantityChange, transactionType, remarks, transactionDate, source, documentRef, location) => {
    ...
    try {
        ...
        // 4. Record history/transaction with additional fields
        // Insert into the stock_history table
        await client.query(
            'INSERT INTO stock_history (item_id, quantity_change, transaction_type, transaction_date, remarks, source, document_ref, location) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)',
            [itemId, quantityChange, transactionType, transactionDate, remarks, source, documentRef, location]
        );
...
const recordIncomingGoods = async (req, res) => {
    ...
    const { itemId, quantity, remarks, transactionDate, source, documentRef, location } = req.body;
    ...
    try {
        ...
        const updatedItem = await updateStockQuantity(
            itemId, 
            quantity, 
            'incoming', 
            remarks, 
